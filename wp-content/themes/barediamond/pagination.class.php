	...
	function getAllPageLinks($count,$href) {
		...
		if($pages>1) {
			if($_GET["page"] == 1) 
				...
				$output = $output . '<a class="link first paginationclicklink" data="' . $href . (1) . '" ><i class="fa fa-backward"></i></a><a class="link paginationclicklink" data="' . $href . ($_GET["page"]-1) . '" ><i class="fa fa-step-backward"></i></a>';
			if(($_GET["page"]-3)>0) {
				if($_GET["page"] == 1)
			...
			if($_GET["page"] < $pages)
				$output = $output . '<a  class="link paginationclicklink" data="' . $href . ($_GET["page"]+1) . '" ><i class="fa fa-step-forward"></i></a><a  class="link paginationclicklink" data="' . $href . ($pages) . '" ><i class="fa fa-forward"></i></a>';
			else
