                    ...
                    <div class="menu-top-menu-container">
                      ...
                      <ul class="nav clearfix">
                         ...
                         <li class="menu-item nav-item dropdown engangement-menu jewelry_menu diamond_menu <?php if($endpartofurl=='diamonds' || $endpartofurl=='?shape=Round' || $endpartofurl=='?shape=Emerald' || $endpartofurl=='?shape=Oval' || $endpartofurl=='?shape=Marquise' || $endpartofurl=='?shape=Cushion' || $endpartofurl=='?shape=Asscher' || $endpartofurl=='?shape=Pear' || $endpartofurl=='?shape=Radiant' || $endpartofurl=='?shape=Princess' || $endpartofurl=='?shape=Asscher') echo 'active-menu';?> ">
                            ...
                            <ul class="sub-menu dropdown-menu">
                              ...
                              <li id="menu-item-1067" class="menu-item">
                                ...
                                <div class="sub-menu menu_items_container">
                                  ...
                                  <div id="menu-item-1077" class="shape_round menu-item menu-item-type-custom menu-item-object-custom menu-item-1077"><a href="<?php bloginfo('url');?>/diamonds/?shape=Round" class="nav-link">Round</a></div>

                                  <div id="menu-item-1070" class="shape_emerald menu-item menu-item-type-custom menu-item-object-custom menu-item-1070"><a href="<?php bloginfo('url');?>/diamonds/?shape=Emerald" class="nav-link">Emerald</a></div>

                                  <div id="menu-item-1073" class="shape_oval menu-item menu-item-type-custom menu-item-object-custom menu-item-1073"><a href="<?php bloginfo('url');?>/diamonds/?shape=Oval" class="nav-link">Oval</a></div>

                                  <div id="menu-item-1072" class="shape_marquise menu-item menu-item-type-custom menu-item-object-custom menu-item-1072"><a href="<?php bloginfo('url');?>/diamonds/?shape=Marquise" class="nav-link">Marquise</a></div>

                                  <div id="menu-item-1069" class="shape_cushion menu-item menu-item-type-custom menu-item-object-custom menu-item-1069"><a href="<?php bloginfo('url');?>/diamonds/?shape=Cushion" class="nav-link">Cushion</a></div>

                                  <div id="menu-item-1068" class="shape_asscher menu-item menu-item-type-custom menu-item-object-custom menu-item-1068"><a href="<?php bloginfo('url');?>/diamonds/?shape=Asscher" class="nav-link">Asscher</a></div>

                                  <div id="menu-item-1074" class="shape_pear menu-item menu-item-type-custom menu-item-object-custom menu-item-1074"><a href="<?php bloginfo('url');?>/diamonds/?shape=Pear" class="nav-link">Pear</a></div>

                                  <div id="menu-item-1076" class="shape_radiant menu-item menu-item-type-custom menu-item-object-custom menu-item-1076"><a href="<?php bloginfo('url');?>/diamonds/?shape=Radiant" class="nav-link">Radiant</a></div>

                                  <div id="menu-item-1075" class="shape_princess menu-item menu-item-type-custom menu-item-object-custom menu-item-1075"><a href="<?php bloginfo('url');?>/diamonds/?shape=Princess" class="nav-link">Princess</a></div>

                                  <div id="menu-item-1071" class="shape_heart menu-item menu-item-type-custom menu-item-object-custom menu-item-1071"><a href="<?php bloginfo('url');?>/diamonds/?shape=Heart" class="nav-link">Heart</a></div>
                            ...
                            <ul class="sub-menu dropdown-menu">
                              ...
                              <li class="menu-item">
                                ...
                                <div class="menu_items_container">
                                  ...
                                  <div><a href="<?php bloginfo('url');?>/stackables/">Stackables</a></div> 
                          ...
                          <li class="menu-item nav-item dropdown"><a href="<?php bloginfo('url');?>/education">Education</a></li>
                          <li class="menu-item nav-item dropdown"><a href="<?php bloginfo('url');?>/our-story">Our Story</a></li>
