...
<table class="form-table">
    ...
    <tr>
        <th>
            <label class="premium-only-label">
                <input <?php echo $free ? 'disabled' : ''; ?> type="checkbox" name="<?php echo Settings::OPTIONS; ?>[tag]"
                                                             value="slug" <?php checked( 'slug', $tag ); ?>>
				<?php esc_html_e( 'Remove product tag base', 'premmerce-url-manager' ) ?>
            </label>
            <p class="description">
                <span class="premium-only-feature"><?php esc_html_e( 'Available only in premium version', 'premmerce-url-manager' ); ?></span>
            </p>
        </th>
    </tr>
    <tr>
        <th>
            ...
            <p class="description"><?php esc_html_e( "Use 'Yoast SEO' primary category to build product path", 'premmerce-url-manager' ) ?></p>
        </th>
    </tr>
    <tr>
        <th>
            ...
            <p class="description"><?php esc_html_e( 'Add canonical meta tag to duplicated pages', 'premmerce-url-manager' ) ?></p>
        </th>
    </tr>
    <tr>
        <th>
            <label class="premium-only-label">
                <input <?php echo $free ? 'disabled' : ''; ?> type="checkbox" name="<?php echo Settings::OPTIONS; ?>[redirect]"
    ...
    <tr>
        <th>
            <label class="premium-only-label">
                <input <?php echo $free ? 'disabled' : ''; ?> type="checkbox" name="<?php echo Settings::OPTIONS; ?>[breadcrumbs]"
					<?php checked( 'on', $breadcrumbs ); ?>>
    ...
    <tr>
        <th>
            <label class="premium-only-label">
                <input <?php echo $free ? 'disabled' : ''; ?> type="checkbox" name="<?php echo Settings::OPTIONS; ?>[br_remove_shop]"
