    ...
    <tr>
        <th>
            <label class="premium-only-label">
                <input <?php echo $free ? 'disabled' : ''; ?> type="text"
                                                             id="permalink_url_suffix"
                                                             name="<?php echo Settings::OPTIONS; ?>[suffix]"
            ...
            <p class="description">
				...
				<?php esc_html_e( 'Specify suffix for your urls. For example ', 'premmerce-url-manager' ); ?> <b>.html</b>
            </p>
        </th>
    </tr>
