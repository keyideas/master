...
function key_diamon_filter_ajs() {
  ...
  $file = get_site_url()."/wp-json/diamond/v1/list/?mincarat=$carat_min&maxcarat=$carat_max&minprice=$price_min&maxprice=$price_max$shape_name$color_max_col$clarity_max_cal$cut_max_ct";
...
function shape_no_images($shape){
  ...
  if($shap_name=="Asscher"){ $no_images=get_template_directory_uri()."/images/asscher.png";}
  if($shap_name=="Cushion"){ $no_images=get_template_directory_uri()."/images/cushion.png";}
  if($shap_name=="Emerald"){ $no_images=get_template_directory_uri()."/images/emerald.png";}
  if($shap_name=="Heart"){ $no_images=get_template_directory_uri()."/images/heart.png"; }
  if($shap_name=="Marquise"){ $no_images=get_template_directory_uri()."/images/marquise.png";}
  if($shap_name=="Oval"){ $no_images=get_template_directory_uri()."/images/oval.png";}
  if($shap_name=="Pear"){ $no_images=get_template_directory_uri()."/images/pear.png";}
  if($shap_name=="Princess"){ $no_images=get_template_directory_uri()."/images/princess.png";}
  if($shap_name=="Radiant"){ $no_images=get_template_directory_uri()."/images/radient.png";}
  if($shap_name=="Round"){ $no_images=get_template_directory_uri()."/images/round.png";}
  return $no_images;
}
?>