...
<div class="bgd_ourstory_section">
	...
	<section class="bgd_banner">
		<img src="<?php echo get_template_directory_uri();?>/images/bgd_our_story_banner.jpg" class="img-fluid w-100 d-none d-sm-none d-md-block" />
		<img src="<?php echo get_template_directory_uri();?>/images/bgd_our-story_banner_mobile.jpg" class="img-fluid w-100 d-block d-sm-block d-md-none" />
	</section>
	...
	<section class="bgd_ourstory_video text-center position-relative">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
	...
	<section class="bgd_stone_section">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-sm-4">
					<div class="bgd_stone_image">
						<img src="<?php echo get_template_directory_uri();?>/images/bgd_stone.jpg" class="img-fluid" />
					</div>
				</div>
